...
<p className="text-center text-white/70 mb-8 text-sm">Manage your community with ease</p>
...
<p className="text-center text-white/60 text-sm">Don't have an account? <span className="text-blue-300 cursor-pointer hover:text-blue-200">Sign up here</span></p>
...
<p className="text-center text-white/60 text-sm">Already have an account? <span className="text-pink-300 cursor-pointer hover:text-pink-200">Login here</span></p>
