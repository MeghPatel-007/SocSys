...
function AdminDashboard() {
  ...
  const [owners] = useState([
    ...
    },
    {
      ...
      phone: "555-0102",
      properties: ["456 Oak Ave", "789 Pine Rd"],
    },
    {
      id: 3,
      name: "Bob Johnson",
  ...
  const [complaints] = useState([
    ...
    },
    {
      ...
      type: "Noise",
      house: "456 Oak Ave",
      description: "Noise from neighbors",
      status: "Resolved",
      date: "2024-03-05",
    },
    {
      ...
      type: "Utilities",
      house: "456 Oak Ave",
      description: "High water bill",
      status: "In Progress",
      date: "2024-03-09",
    },
    {
      id: 4,
      complainant: "Eva Wilson",
      type: "Maintenance",
      house: "321 Elm St",
            ...
            <div className="dashboard-hero-row">
              <div>
                ...
                <p className="text-blue-100 mt-2">
                  Manage your society properties and residents
                </p>
              </div>
                ...
                {houses.map((house) => (
                  ...
                  >
                    ...
                    <div className="space-y-2 text-sm text-gray-400">
                      ...
                      <p>
                        <strong>Units:</strong> {house.units}
                      </p>
                    </div>
                  </div>
                ))}
                ...
                {complaints.map((complaint) => (
                  ...
                  >
                    ...
                    <div className="space-y-2 text-sm">
                      <p>
                        <strong>Type:</strong>{" "}
                        <span className="text-blue-400">{complaint.type}</span>
                      </p>
                      <p>
                      ...
                      <p>
                        <strong>Date:</strong>{" "}
                        <span className="text-gray-400">{complaint.date}</span>
                      </p>
                    </div>
                  </div>
                ))}
